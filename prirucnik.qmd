...
::: {.guide-plate}
![](images/prirucnik/ph2.jpg){fig-alt="Ilustrirani plakat: građani i interesne skupine povlače uže oko državnog proračuna podijeljenog na zdravstvo i socijalnu zaštitu, uz kartu Hrvatske te ikone institucija, politike i ekonomije." width="100%"}
:::
:::
...
::: {.content-hidden when-format="latex"}
::: {.guide-plate}
![](images/prirucnik/ph-vodic.png){fig-alt="Ilustrirani vodič kroz strukturu knjige: pet dijelova prikazani su kao pregledna karta s ključnim temama — klasične javne financije, javni izbor, institucije, politike u praksi i reforme." width="100%"}
:::
:::
