...
<section class="up-section">
  ...
  <div class="up-network-box">
    ...
    <ul>
      <li>Svaka mentalna mapa čita se od rubova prema sredini. Periferija su primjeri, a središte je mehanizam koji ih ujedinjuje.</li>
      <li>Iste pojmove naći ćete u više mapa. To nije greška nego namjera; repetitivno susretanje pojma u različitim kontekstima gradi trajno razumijevanje.</li>
      <li>Mape su kompresija, a ne supstitut za tekst. Vraćajte se u poglavlje kad vam treba kontekst.</li>
    </ul>
  </div>
  ...
  <div class="up-spotlight">
    ...
    <ul>
      <li>Linearno praćenje redosljeda poglavlja (01 → 22) funkcionira jer se svaka mapa nadovezuje na prethodnu i uvodi pojmove koji će biti ključni u sljedećoj.</li>
      <li>Tematski pristup znači otvaranje mape poglavlja koje upravo čitate kao vizualnu dopunu; pregled pomaže da se ne izgubite u dugačkim odsjeccima.</li>
      <li>Uoči ispita prođite sve mape bez otvaranja knjiga. Svaka veza koja nije jasna signal je gdje treba zuriti natrag u tekst.</li>
    </ul>
  </div>
</section>
...
<section class="up-section">
  ...
  <div class="up-spotlight">
    ...
    <ul>
      <li><strong>Čvorovi</strong> su ključni pojmovi knjige, koji obuhvaćaju teorijske koncepte, ekonomske termine, institucije i mehanizme.</li>
      <li><strong>Bridovi</strong> označavaju semantičku vezu između pojmova, bilo uzročno-posljedičnu ("vodi do"), kontrastnu ("za razliku od") ili analognu ("slično kao").</li>
      <li><strong>Boja i veličina čvora</strong> odražavaju centralnost pojma; što više veza čvor ima, to je pojam centraliji u mreži.</li>
    </ul>
  ...
  <div class="up-spotlight">
    ...
    <ul>
      ...
      <li>Povucite čvorove za preuređivanje pogleda; fizikalna simulacija drži graf na okupu.</li>
      <li>Koristite polje za pretragu za direktno pronalaženje pojma po nazivu.</li>
      <li>Prebacite se između mrežnog prikaza i popisa jer je lista korisnija za abecedno traženje.</li>
    </ul>
  </div>
</section>
...
<section class="up-section">
  ...
  <div class="up-spotlight">
    ...
    <ul>
      <li>Umjesto "što je eksternalija?" bolje je pitati "zašto eksternalija dovodi do neoptimalne alokacije, korak po korak". Definiciju asistent može izmisliti; mehanizam iz teksta mora biti točan.</li>
      <li>Tražite primjer koji nije u tekstu. Upit poput "Navedi primjer eksternalije koji nije u poglavlju" testira razumijevanje, a ne reprodukciju.</li>
      <li>AI asistenti povremeno griješe. Uvijek provjerite ključne tvrdnje u izvornom poglavlju.</li>
      <li>Za pripremu ispita tražite pitanja umjesto odgovora. Upit "Postavi mi pet pitanja o Arrowovom teoremu kojima bih mogao/la biti testiran/a" dobar je model.</li>
      <li>Na <a href="uci-s-ai.html">Uči uz AI</a> dostupna je i kompletna <code>llms-full.txt</code> datoteka s cijelom knjigom, namijenjena modelima s većim kontekstnim prozorom.</li>
    </ul>
  </div>
</section>
