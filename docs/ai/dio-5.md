...
Međutim, činjenica da tržište može zakazati ne znači da će država automatski uspjeti. To je središnja pouka literature o neuspjesima države. Već je Wolf (Wolf, 1979) upozorio da se javna intervencija ne smije opravdavati samo postojanjem tržišnog neuspjeha, nego se mora analizirati i mogućnost da sama država proizvede neučinkovite ili neželjene ishode. U dobroj analizi javnih politika ne uspoređuje se savršeno tržište sa savršenom državom, nego dva nesavršena mehanizma društvene koordinacije, tržište i država.
...
**Provedbeni neuspjeh** nastaje kada dobro zamišljena politika zakazuje u fazi provedbe zbog nedostatka administrativnog kapaciteta, nejasne raspodjele odgovornosti ili implementacijskog jaza između formalne odluke i stvarnog djelovanja uličnih birokrata (Pressman, 1973; Lipsky, 1980).

U teoriji javnih politika ovaj je problem poznat kao **implementacijski jaz**, razlika između onoga što je formalno odlučeno i onoga što se stvarno događa u provedbi (Pressman, 1973). Lipsky (Lipsky, 1980) dodatno naglašava važnost ulične birokracije, gdje učitelji, liječnici, policajci i službenici na šalterima često u praksi odlučuju kako će politika stvarno izgledati za građane. Provedbeni neuspjeh posebno je važan za zemlje koje često donose reforme pod pritiskom kriza ili međunarodnih preporuka, ali nemaju dovoljno kapaciteta za njihovu provedbu. Schick (Schick, 1998) upozorava da zemlje slabijeg administrativnog kapaciteta ne bi trebale nekritički preuzimati sofisticirane reformske modele. Provedba zato nije tehnički detalj koji dolazi nakon „prave" politike, nego je dio same politike.
...
*Slika. Interaktivni test državnog neuspjeha — što je politika slabija na pojedinoj dimenziji, to je veći rizik da zakaže u provedbi, a ukupna ocjena pokazuje gdje dizajn treba ojačati prije provedbe.*
...
1. Daljnje čitanje: Waters i Wernham (2024), *Universal Credit: incomes, incentives and the remaining roll-out* (https://ifs.org.uk/publications/universal-credit-incomes-incentives-and-remaining-roll-out) (IFS).
2. Formalni izvor kratkoročnosti je problem vremenske nekonzistentnosti (Kydland, 1977). Politika koja je optimalna kada se najavi, $\pi^{*}_{t}$, ne mora biti ona koju je akteru optimalno provesti kada za to dođe trenutak, $$\pi^{*}_{t}\;\big(\text{ex ante}\big) \;\neq\; \underbrace{\arg\max_{\pi}\; U\big(\pi \mid \pi^{e}=\pi^{*}_{t}\big)}_{=\;\pi^{d}_{t}\;(\text{ex post})}$$ jer uz već usidrena očekivanja $\pi^{e}$ postoji iskušenje devijacije $\pi^{d}_{t}$. Bez vjerodostojnog mehanizma obvezivanja diskrecija stoga sustavno odstupa od najavljenog optimuma, što povezuje kratkoročnost iz ovog poglavlja s pravilima iz poglavlja o konstitucionalnoj ekonomici.
...
Hrvatski stupac od 0,882 nadvisuje isprekidanu liniju prosjeka, no zaostatak za vrhom ljestvice nije zanemariv jer Danska i Estonija prelaze 0,97. Riječ je o solidnoj infrastrukturi, dakle o onome što je menadžerski pristup obećao i u dobroj mjeri isporučio, jer su portali, elektronički identitet i digitalne usluge danas opipljiv nasljednik orijentacije prema korisniku.

Ta solidna infrastruktura otvara napetost koju ćemo razložiti u poglavlju o novom upravljanju. Dobra tehnička podloga sama po sebi ne stvara povjerenje građana u vlast, a Hrvatska je primjer zemlje koja stoji razmjerno visoko po digitalnoj razvijenosti, ali nisko po povjerenju u institucije koje te usluge pružaju. Estonija, koja u ovom prikazu stoji odmah uz vrh, pokazuje da to dvoje može ići zajedno jer je digitalizaciju javne uprave gradila istodobno s vjerodostojnošću institucija. Infrastruktura je nužan, ali ne i dovoljan uvjet, a koliko ona vrijedi bez povjerenja vidjet ćemo kad povjerenje izmjerimo izravno.
