...
::: {#def-lov-na-rentu}
**Lov na rentu** (*rent-seeking*) je ulaganje resursa u stjecanje političkih povlastica (monopolske zaštite, dozvola, subvencija, kvota) umjesto u stvaranje novih vrijednosti; rezultira dvostrukim društvenim gubitkom — izravnim iskrivljavanjem tržišnih cijena i neizravnim gubitkom resursa potrošenih na samo natjecanje za povlasticu [@tullock1967; @krueger1974].
:::
...
**Regulatorno zarobljavanje** (*regulatory capture*) je proces u kojemu regulator, osnovan da štiti javni interes, postupno počne djelovati u interesu sektora koji nadzire — najčešće zbog informacijske ovisnosti, organizacijske asimetrije i pojave kružnih vrata, a ne nužno korupcije [@stigler1971; @peltzman1976].
:::
