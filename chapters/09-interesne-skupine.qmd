...
//| fig-alt: "Graf s dvjema točkama po zemlji koje povezuje crta. Lijeva točka je sindikalna gustoća, desna pokrivenost kolektivnim ugovorima. U Francuskoj je gustoća 10 % a pokrivenost 98 %, najveći razmak; u Švedskoj i Finskoj obje su visoke; Hrvatska je u sredini s gustoćom 20,8 % i pokrivenošću 52,7 %."
{
  const rows = [
  ...
  return Plot.plot({
    ...
    marks: [
      Plot.link(rows, {x1: "gustoca", x2: "pokrivenost", y: "zemlja", stroke: "#C9C3B8", strokeWidth: 2.5}),
...
#| fig-alt: "Dumbbell graf sindikalne gustoće i pokrivenosti kolektivnim ugovorima za šest zemalja; Francuska ima najveći razmak (10 % naspram 98 %), Hrvatska je u sredini (20,8 % i 52,7 %)."
#| fig-width: 7.8
#| fig-height: 3.9
source("R/setup.R")
