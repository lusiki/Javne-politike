...
ggplot(df) +
  ...
  geom_text(aes(x = hr, y = dim, label = sprintf("%.0f", hr)), vjust = -1.1, size = 2.6, color = "#333333") +
  geom_text(aes(x = si, y = dim, label = sprintf("%.0f", si)), vjust = -1.1, size = 2.6, color = "#7A7A7A") +
  scale_color_manual(values = c("Hrvatska" = "#1A1A1A", "Slovenija" = "#7A7A7A"), name = NULL) +
