...
ggplot(curve_df, aes(s, u)) +
  ...
  annotate("text", x = s_sel, y = cur_u, label = lbl_uspjeh,
           vjust = -1.4, fontface = "bold", size = 4.2, color = "#1C1916") +
...
::: {.callout-praksa}
Redoslijed reformi najjasnije se vidi na liberalizaciji kapitalnog računa. U zemljama koje su prvo izgradile snažnu bankarsku regulaciju i nadzor, otvaranje prema slobodnom kretanju kapitala donijelo je dugoročne koristi kroz pristup financiranju i ulaganjima. U zemljama koje su kapitalni račun otvorile prije nego što su uspostavile nadzor nad bankama, isti je potez često ubrzao kreditne procvate i financijske krize. Sadržaj mjere bio je isti, ali je ishod ovisio o tome je li institucionalna podloga postojala u trenutku provedbe. Primjer potvrđuje da redoslijed nije tehnički detalj koji dolazi nakon „prave" reforme, nego sastavni dio njezina sadržaja.[^wp-ch19]
:::
