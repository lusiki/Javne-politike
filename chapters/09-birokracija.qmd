...
(c) Izračunajte prekomjernu ponudu kao razliku Qₙ − Q\* te procijenite gubitak društvene vrijednosti na rasponu od Q\* do Qₙ, gdje za svaku dodatnu jedinicu trošak premašuje korist.

Objasnite zatim zašto birokracija uspijeva nametnuti razinu Qₙ, a ne Q\*. Povežite odgovor s monopolom nad uslugom i s informacijskom prednošću birokracije nad sponzorom koji ne može provjeriti stvarni odnos koristi i troška svake dodatne jedinice. Što vaš rezultat otkriva o tome zašto pitanje koliko novca institucija traži nije isto što i pitanje koliko bi sredstava bilo društveno opravdano?
:::
...
Regulatorno zarobljavanje može nastati na više načina. Prvi je **informacijski**, jer regulirana industrija zna mnogo više o tehnologiji, troškovima i rizicima od regulatora. Drugi je **organizacijski**, jer su regulirana poduzeća malobrojna i dobro organizirana, dok su potrošači brojni i raspršeni. Treći je **karijerni**, jer službenici prelaze u privatni sektor i obratno. Četvrti je **kulturni**, jer regulator i industrija s vremenom dijele isti stručni jezik i pretpostavke o tome što je „realno" i „provedivo". Regulator tada više ne mora biti formalno korumpiran da bi bio zarobljen, dovoljno je da počne gledati svijet očima regulirane industrije.

Regulacija nije automatski javni interes u akciji. Ona je institucionalni proces koji i sam može biti predmet političkih i ekonomskih interesa. Zato nije dovoljno osnovati neovisnog regulatora; potrebno je oblikovati sustav koji smanjuje rizik zarobljavanja kroz javna savjetovanja, transparentne odluke, objavu podataka, sprječavanje sukoba interesa i nadzor.

### Model političko-proračunskih ciklusa

Teorija javnog izbora primjenjuje se i na model **političko-proračunskih ciklusa**. Osnovna ideja jest da političari, budući da žele pobijediti na izborima, mogu koristiti fiskalnu politiku kako bi povećali popularnost uoči izbora, kroz rast javnih rashoda, povećanje plaća u javnom sektoru, širenje transfera ili smanjenje poreza [@nordhaus1975].

Model polazi od razlike između kratkoročnih političkih koristi i dugoročnih ekonomskih troškova. Povećanje potrošnje prije izbora donosi vidljive koristi, dok se troškovi pojavljuju kasnije u obliku većeg deficita, javnog duga ili potrebe za fiskalnom konsolidacijom. Birokracija u tom procesu ima ambivalentnu ulogu. Profesionalna administracija u ministarstvu financija, fiskalnim vijećima i revizorskim institucijama može djelovati kao stabilizator i upozoravati na dugoročne troškove, ali birokracija može imati i interes podržati rast potrošnje jer joj donosi više resursa i ovlasti.

Proračun nije samo tehnički dokument, nego politički instrument. Zato analiza javne potrošnje mora uzeti u obzir izbore, biračke poticaje, interesne skupine i administrativne interese. Fiskalna pravila, srednjoročni proračunski okviri i neovisna fiskalna vijeća postoje upravo zato da bi ograničili kratkoročni politički pritisak na rast potrošnje i učinili troškove političkih odluka vidljivijima.
