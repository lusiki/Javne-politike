...
::: {.callout-note}
**Grafikon: Opadajuća korisnost dohotka** — u pripremi.
:::
...
::: {.callout-note}
**Grafikon: Porezna incidencija (ponuda i potražnja)** — u pripremi.
:::

::: {.callout-note}
**Grafikon: Mrtvi teret poreza** — u pripremi.
:::
...
::: {.callout-note}
**Grafikon: Porezni klin** — u pripremi.
...
::: {.callout-note}
**Grafikon: Elastičnost i mrtvi teret poreza** — u pripremi.
:::
...
::: {.callout-note}
**Graf: Porez i ponuda rada** — u pripremi.
...
::: {.callout-note}
**Grafikon: Intertemporalni izbor** — u pripremi. Prikazuje kako oporezivanje kapitala ili kamate utječe na odluku raspodjele potrošnje između sadašnjosti i budućnosti.
:::
...
::: {.callout-note}
**Graf: Lafferova krivulja** — u pripremi.
:::
