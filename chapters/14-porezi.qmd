...
//| echo: false
{
  ...
  return Plot.plot({
    ...
    marginLeft: 65,
    marginBottom: 55,
    style: {fontSize: "12px", fontFamily: "Geist, system-ui, sans-serif", color: "#5A4F3F"},
    x: {label: "Dohodak (Y) →", domain: [0, Ymax], grid: false},
    y: {label: "↑ Ukupna korisnost (U)", domain: [Math.min(0, U(1)), Umax * 1.08], grid: true},
    marks: [
      Plot.ruleY([0], {stroke: "#D8CCB8"}),
      Plot.line(curve, {x: "Y", y: "U", stroke: "#2D5A8E", strokeWidth: 2.5}),

      // Original positions (faded)
      Plot.dot([{Y: yp, U: Up}, {Y: yr, U: Ur}],
        {x: "Y", y: "U", r: 5, fill: "#9F907B", stroke: "white", strokeWidth: 1.5}),
      Plot.ruleX([yp, yr], {y1: 0, y2: d => d === yp ? Up : Ur, stroke: "#D8CCB8", strokeDasharray: "2,2"}),

      // New positions after transfer
      Plot.dot([{Y: ypNew, U: UpNew}], {x: "Y", y: "U", r: 6, fill: "#2F7A5C", stroke: "white", strokeWidth: 2}),
      Plot.dot([{Y: yrNew, U: UrNew}], {x: "Y", y: "U", r: 6, fill: "#9C302B", stroke: "white", strokeWidth: 2}),

      // Lines showing the transfer movement on the x axis
      Plot.link(
        [{x1: yp, y1: Umax * 0.04, x2: ypNew, y2: Umax * 0.04}],
        {x1: "x1", y1: "y1", x2: "x2", y2: "y2",
         stroke: "#2F7A5C", strokeWidth: 2.5, markerEnd: "arrow"}),
      Plot.link(
        [{x1: yr, y1: Umax * 0.04, x2: yrNew, y2: Umax * 0.04}],
        {x1: "x1", y1: "y1", x2: "x2", y2: "y2",
         stroke: "#9C302B", strokeWidth: 2.5, markerEnd: "arrow"}),

      // Vertical brackets showing utility change
      Plot.ruleX([ypNew], {y1: Up, y2: UpNew, stroke: "#2F7A5C", strokeWidth: 3}),
      Plot.ruleX([yrNew], {y1: UrNew, y2: Ur, stroke: "#9C302B", strokeWidth: 3}),

      // Labels
      Plot.text([{x: ypNew, y: UpNew, label: `+${dUp.toFixed(2)}`}],
        {x: "x", y: "y", text: "label", textAnchor: "start", dx: 8, dy: -8,
         fontSize: 13, fill: "#2F7A5C", fontWeight: 700}),
      Plot.text([{x: yrNew, y: UrNew, label: `${dUr.toFixed(2)}`}],
        {x: "x", y: "y", text: "label", textAnchor: "start", dx: 8, dy: 14,
         fontSize: 13, fill: "#9C302B", fontWeight: 700}),

      Plot.text([{x: 2, y: Umax * 1.04, label: `Δ Ukupna korisnost: ${dUtot >= 0 ? "+" : ""}${dUtot.toFixed(2)}`}],
        {x: "x", y: "y", text: "label", textAnchor: "start",
         fontSize: 14, fill: dUtot >= 0 ? "#2F7A5C" : "#9C302B", fontWeight: 700}),
  ...
  return Plot.plot({
    ...
    marks: [
      ...
      Plot.line([...buyerRect, buyerRect[0]],
        {x: "Q", y: "P", stroke: "#2D5A8E", strokeWidth: 1, fill: "#C5D6E6", fillOpacity: 0.55, curve: "linear"}),
      Plot.line([...sellerRect, sellerRect[0]],
        {x: "Q", y: "P", stroke: "#C57832", strokeWidth: 1, fill: "#F0DFC0", fillOpacity: 0.55, curve: "linear"}),

      // Curves
      Plot.line(demand,    {x: "Q", y: "P", stroke: "#2D5A8E", strokeWidth: 2.5}),
      Plot.line(supply,    {x: "Q", y: "P", stroke: "#2F7A5C", strokeWidth: 2}),
      Plot.line(supplyTax, {x: "Q", y: "P", stroke: "#2F7A5C", strokeWidth: 2, strokeDasharray: "6,4"}),

      // Price guides
      Plot.ruleY([Pc],    {stroke: "#9F907B", strokeDasharray: "2,2"}),
      Plot.ruleY([Pp],    {stroke: "#9F907B", strokeDasharray: "2,2"}),
      Plot.ruleY([Pstar], {stroke: "#5A4F3F", strokeDasharray: "4,3", strokeWidth: 1}),

      // Tax wedge
      Plot.ruleX([Qt], {y1: Pp, y2: Pc, stroke: "#9C302B", strokeWidth: 3}),

      // Equilibrium markers
      Plot.dot([{Q: Qstar, P: Pstar}], {x: "Q", y: "P", r: 5, fill: "#5A4F3F", stroke: "white", strokeWidth: 2}),
      Plot.dot([{Q: Qt, P: Pc}, {Q: Qt, P: Pp}],
        {x: "Q", y: "P", r: 4, fill: "#9C302B", stroke: "white", strokeWidth: 1.5}),
      ...
      Plot.text([{x: Qmax * 0.85, y: c + d_slope * Qmax * 0.85, label: `S (εS=${eps_s.toFixed(2)})`}],
        {x: "x", y: "y", text: "label", fill: "#2F7A5C", fontSize: 12, fontWeight: 600, dy: -8}),
      Plot.text([{x: Qmax * 0.85, y: c + t + d_slope * Qmax * 0.85, label: "S + t"}],
        {x: "x", y: "y", text: "label", fill: "#2F7A5C", fontSize: 12, fontWeight: 600, dy: -8}),

      // Price labels
      Plot.text([{x: 2, y: Pc, label: `Pc = ${Pc.toFixed(1)}`}],
        {x: "x", y: "y", text: "label", textAnchor: "start", dy: -8, fontSize: 12, fill: "#171411"}),
      Plot.text([{x: 2, y: Pp, label: `Pp = ${Pp.toFixed(1)}`}],
        {x: "x", y: "y", text: "label", textAnchor: "start", dy: 14, fontSize: 12, fill: "#171411"}),
      Plot.text([{x: 2, y: Pstar, label: `P* = ${Pstar.toFixed(1)}`}],
        {x: "x", y: "y", text: "label", textAnchor: "start", dy: -6, fontSize: 11, fill: "#5A4F3F"}),
      ...
      Plot.text([{x: 2, y: Pmax * 0.91, label: `Teret prodavača: ${(sellerShare * 100).toFixed(0)} %`}],
        {x: "x", y: "y", text: "label", textAnchor: "start",
         fontSize: 14, fill: "#A85F28", fontWeight: 700})
    ]
  });
}
```
  ...
  return Plot.plot({
    ...
    marks: [
      ...
      Plot.line([...dwlTriangle, dwlTriangle[0]],
        {x: "Q", y: "P", stroke: "#9C302B", strokeWidth: 2,
         fill: "#E3B5B0", fillOpacity: 0.75, curve: "linear"}),
      ...
      Plot.link(
        ...
        {x1: "x1", x2: "x2", y1: "y1", y2: "y2",
         stroke: "#5A4F3F", strokeWidth: 2.5, markerStart: "dot", markerEnd: "dot"}),
  ...
  return Plot.plot({
    ...
    marks: [
      ...
      Plot.line([...wedgeRect, wedgeRect[0]],
        {x: "L", y: "W", stroke: "#5A4F3F", strokeWidth: 1,
         fill: "#D5C8B8", fillOpacity: 0.6, curve: "linear"}),

      // Curves
      Plot.line(demand,    {x: "L", y: "W", stroke: "#2D5A8E", strokeWidth: 2.5}),
      Plot.line(supply,    {x: "L", y: "W", stroke: "#2F7A5C", strokeWidth: 2}),
      Plot.line(supplyTax, {x: "L", y: "W", stroke: "#2F7A5C", strokeWidth: 2, strokeDasharray: "6,4"}),

      // Wage guides
      Plot.ruleY([Wbruto], {stroke: "#9F907B", strokeDasharray: "2,2"}),
      Plot.ruleY([Wneto],  {stroke: "#9F907B", strokeDasharray: "2,2"}),

      // Vertical wedge line
      Plot.ruleX([Lt], {y1: Wneto, y2: Wbruto, stroke: "#9C302B", strokeWidth: 3}),

      // Equilibrium dots
      Plot.dot([{L: Lstar, W: Wstar}], {x: "L", y: "W", r: 5, fill: "#5A4F3F", stroke: "white", strokeWidth: 2}),
      Plot.dot([{L: Lt, W: Wbruto}, {L: Lt, W: Wneto}],
        {x: "L", y: "W", r: 4, fill: "#9C302B", stroke: "white", strokeWidth: 1.5}),
      ...
      Plot.text([{x: 2, y: Wbruto, label: `Bruto nadnica = ${Wbruto.toFixed(1)}`}],
        {x: "x", y: "y", text: "label", textAnchor: "start", dy: -8, fontSize: 12, fill: "#171411", fontWeight: 600}),
      Plot.text([{x: 2, y: Wneto, label: `Neto nadnica = ${Wneto.toFixed(1)}`}],
        {x: "x", y: "y", text: "label", textAnchor: "start", dy: 14, fontSize: 12, fill: "#171411", fontWeight: 600}),
      ...
      Plot.text([{x: 2, y: Wmax * 0.97,
        ...
        {x: "x", y: "y", text: "label", textAnchor: "start",
         fontSize: 13, fill: "#43392B", fontWeight: 700}),
    ...
    marks: [
      ...
      Plot.line([...revRect, revRect[0]],
        {x: "Q", y: "P", stroke: "#2D5A8E", strokeWidth: 1,
         fill: "#C5D6E6", fillOpacity: 0.5, curve: "linear"}),

      // Deadweight-loss triangle (red fill) — closed polygon via line with fill
      Plot.line([...dwlTriangle, dwlTriangle[0]],
        {x: "Q", y: "P", stroke: "#9C302B", strokeWidth: 2,
         fill: "#E3B5B0", fillOpacity: 0.7, curve: "linear"}),
...
//| echo: false
{
  ...
  return Plot.plot({
    ...
    marks: [
      ...
      // Budget lines
      Plot.line(budgetNoTax, {x: "ell", y: "C", stroke: "#2F7A5C", strokeWidth: 2.5}),
      Plot.line(budgetTax,   {x: "ell", y: "C", stroke: "#2F7A5C", strokeWidth: 2, strokeDasharray: "6,4"}),

      // Indifference curves
      Plot.line(indiffA, {x: "ell", y: "C", stroke: "#2D5A8E", strokeWidth: 2}),
      Plot.line(indiffC, {x: "ell", y: "C", stroke: "#9C302B", strokeWidth: 2, strokeDasharray: "4,3"}),

      // Substitution-effect arrow (A → B) on the x-axis baseline
      Plot.link(
        [{x1: A.ell, y1: Cmax * 0.06, x2: B.ell, y2: Cmax * 0.06}],
        {x1: "x1", y1: "y1", x2: "x2", y2: "y2",
         stroke: "#5A4F3F", strokeWidth: 2.5, markerEnd: "arrow"}),
      // Income-effect arrow (B → C) on a separate baseline
      Plot.link(
        [{x1: B.ell, y1: Cmax * 0.02, x2: C_pt.ell, y2: Cmax * 0.02}],
        {x1: "x1", y1: "y1", x2: "x2", y2: "y2",
         stroke: "#C57832", strokeWidth: 2.5, markerEnd: "arrow"}),

      // Three optima
      Plot.dot([A], {x: "ell", y: "C", r: 6, fill: "#2D5A8E", stroke: "white", strokeWidth: 2}),
      Plot.dot([B], {x: "ell", y: "C", r: 6, fill: "#5A4F3F", stroke: "white", strokeWidth: 2}),
      Plot.dot([C_pt], {x: "ell", y: "C", r: 6, fill: "#9C302B", stroke: "white", strokeWidth: 2}),

      // Drop-lines from optima to x-axis (faded)
      Plot.ruleX([A.ell],    {y1: 0, y2: A.C,    stroke: "#C5D6E6", strokeDasharray: "2,2"}),
      Plot.ruleX([C_pt.ell], {y1: 0, y2: C_pt.C, stroke: "#EBC9C5", strokeDasharray: "2,2"}),
      ...
      Plot.text([{x: (A.ell + B.ell) / 2, y: Cmax * 0.06,
        ...
        {x: "x", y: "y", text: "label", textAnchor: "middle", dy: -8,
         fontSize: 11, fill: "#43392B", fontWeight: 600}),
...
//| echo: false
{
  ...
  return Plot.plot({
    ...
    marks: [
      ...
      // Budget line — no tax
      Plot.line(budgetNoTax, {x: "C1", y: "C2", stroke: "#2F7A5C", strokeWidth: 2.5}),
      // Budget line — with tax
      Plot.line(budgetTax,   {x: "C1", y: "C2", stroke: "#2F7A5C", strokeWidth: 2, strokeDasharray: "6,4"}),

      // Indifference curves
      Plot.line(indiffBefore, {x: "C1", y: "C2", stroke: "#2D5A8E", strokeWidth: 2}),
      Plot.line(indiffAfter,  {x: "C1", y: "C2", stroke: "#9C302B", strokeWidth: 2, strokeDasharray: "4,3"}),

      // Endowment point
      Plot.dot([{C1: Y, C2: 0}], {x: "C1", y: "C2", r: 4, fill: "#5A4F3F", stroke: "white", strokeWidth: 1.5}),

      // Optima
      Plot.dot([before], {x: "C1", y: "C2", r: 6, fill: "#2D5A8E", stroke: "white", strokeWidth: 2}),
      Plot.dot([after],  {x: "C1", y: "C2", r: 6, fill: "#9C302B", stroke: "white", strokeWidth: 2}),

      // Drop-lines for both optima
      Plot.ruleX([before.C1], {y1: 0, y2: before.C2, stroke: "#C5D6E6", strokeDasharray: "2,2"}),
      Plot.ruleY([before.C2], {x1: 0, x2: before.C1, stroke: "#C5D6E6", strokeDasharray: "2,2"}),
      Plot.ruleX([after.C1],  {y1: 0, y2: after.C2,  stroke: "#EBC9C5", strokeDasharray: "2,2"}),
      Plot.ruleY([after.C2],  {x1: 0, x2: after.C1,  stroke: "#EBC9C5", strokeDasharray: "2,2"}),
...
//| echo: false
{
  ...
  return Plot.plot({
    ...
    marks: [
      ...
      Plot.areaY(curve, {x: "t", y: "R", fill: "#C5D6E6", fillOpacity: 0.25}),

      // Revenue-maximising rate: vertical dashed line + dot
      Plot.ruleX([tStar * 100], {y1: 0, y2: Rmax, stroke: "#5A4F3F", strokeDasharray: "4,3"}),
      Plot.dot([{t: tStar * 100, R: Rmax}],
        {x: "t", y: "R", r: 6, fill: "#171411", stroke: "white", strokeWidth: 2}),

      // Reader's current point
      Plot.ruleX([tCur * 100], {y1: 0, y2: Rcur,
        stroke: onRising ? "#2F7A5C" : "#9C302B", strokeDasharray: "2,2"}),
      Plot.ruleY([Rcur], {x1: 0, x2: tCur * 100,
        stroke: onRising ? "#2F7A5C" : "#9C302B", strokeDasharray: "2,2"}),
      Plot.dot([{t: tCur * 100, R: Rcur}],
        {x: "t", y: "R", r: 7,
         fill: onRising ? "#2F7A5C" : "#9C302B", stroke: "white", strokeWidth: 2}),
      ...
      Plot.text([{t: tCur * 100, R: Rcur,
        ...
        {x: "t", y: "R", text: "label",
         ...
         fontSize: 12, fill: onRising ? "#2F7A5C" : "#9C302B", fontWeight: 700}),
