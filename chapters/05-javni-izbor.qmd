...
verdict_color <- if (Rcur >= 0) "#1C7C54" else "#C53030"
...
accent <- if (votes) "#1C7C54" else "#6B1F26"
...
ggplot(df, aes(act, regret, fill = pick)) +
  ...
  geom_text(aes(label = regret), vjust = -0.5, fontface = "bold",
            size = 4.2, color = "#1C1916") +
  scale_fill_manual(values = c(`TRUE` = "#4A6B5C", `FALSE` = "#C9BBA3"), guide = "none") +
