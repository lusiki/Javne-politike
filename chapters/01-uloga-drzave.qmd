...
col_box   <- "#3A332D"  # obris kutije, oznake osi, tekst legende
col_cc    <- "#1C7C54"  # krivulja ugovora (zelena)
col_a     <- "#2D5A8E"  # krivulje indiferencije A (plava)
col_b     <- "#C53030"  # krivulje indiferencije B (crvena)
col_dot   <- "#1C1916"  # tangentne točke i oznake A/B/C
