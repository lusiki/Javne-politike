...
//| fig-cap: "Ukupni rashodi opće države u % BDP-a, Hrvatska i prosjek EU27, 2002.–2024. Zlatno je Hrvatska, tamno prosjek Unije. Vrhunac u 2020. odražava pandemijski fiskalni odgovor. Izvor: Eurostat (gov_10a_main, sektor opće države S13)."
//| fig-alt: "Linijski graf ukupnih rashoda opće države u postotku BDP-a od 2002. do 2024. za Hrvatsku (zlatno) i prosjek EU27 (tamno). Obje serije kreću se oko 45 do 51 % BDP-a, uz nagli skok u 2020. na 53,8 % za Hrvatsku i 52,9 % za EU."
{
  ...
  return Plot.plot({
    ...
    y: {label: "↑ Rashodi opće države (% BDP-a)", domain: [40, 56], grid: true},
    color: {domain: ["Hrvatska","EU27"], range: ["#C8942D","#1C1916"], legend: true},
    marks: [
...
#| echo: false
#| fig-cap: "Ukupni rashodi opće države u % BDP-a, Hrvatska i prosjek EU27, 2002.–2024. Zlatno je Hrvatska, tamno prosjek Unije. Vrhunac u 2020. odražava pandemijski fiskalni odgovor. Izvor: Eurostat (gov_10a_main)."
#| fig-alt: "Linijski graf ukupnih rashoda opće države u postotku BDP-a od 2002. do 2024. za Hrvatsku (zlatno) i prosjek EU27 (tamno), uz nagli skok u 2020."
#| fig-width: 7.8
#| fig-height: 4.4
source("R/setup.R")
...
ggplot(df, aes(god, v, color = serija)) +
  ...
  scale_color_manual(values = c("Hrvatska" = "#C8942D", "EU27" = "#4A5568"), name = NULL) +
