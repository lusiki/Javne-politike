...
//| fig-cap: "Ukupni porezni teret (porezi i doprinosi, % BDP-a) za odabrane zemlje. Zlatno je istaknuta Hrvatska, zeleno prosjek OECD-a. Izvor: OECD, Revenue Statistics 2025 (2023.); Hrvatska, Slovenija i Mađarska prema Eurostatu (2024.)."
//| fig-alt: "Vodoravni stupčasti graf ukupnog poreznog tereta u postotku BDP-a za jedanaest zemalja. Danska je na vrhu s 44,0 %, a Meksiko na dnu s 17,7 %. Hrvatska s 38,6 % nalazi se u gornjoj polovici, iznad Njemačke i prosjeka OECD-a od 33,7 %."
{
  const data = [
...
//| fig-cap: "Porezi i doprinosi u odabranim članicama EU, 2024. (% BDP-a), razloženi na tri glavne skupine. Hrvatska se izdvaja najvećim udjelom neizravnih poreza (zlatno) u BDP-u (Eurostat)."
//| fig-alt: "Vodoravni složeni stupčasti graf za sedam europskih sustava (Danska, Francuska, Njemačka, EU prosjek, Hrvatska, Mađarska, Irska). Svaki je stupac razložen na neizravne poreze, izravne poreze te socijalne doprinose, izražene u postotku BDP-a. Hrvatska i Mađarska imaju najširi pojas neizravnih poreza."
{
  ...
  return Plot.plot({
    ...
    marks: [
      Plot.barX(data, {x: "val", y: "z", fill: "cat", order: cats, tip: true}),
      Plot.text(totals, {x: "t", y: "z", text: d => d.t.toFixed(1).replace(".", ","), dx: 5, textAnchor: "start", fontSize: 10, fontWeight: 600, fill: "#3A332D"}),
      Plot.ruleX([0])
    ]
  });
}
...
#| echo: false
#| fig-cap: "Porezi i doprinosi u odabranim članicama EU, 2024. (% BDP-a), razloženi na tri glavne skupine. Hrvatska se izdvaja najvećim udjelom neizravnih poreza u BDP-u (Eurostat)."
#| fig-alt: "Vodoravni složeni stupčasti graf za sedam europskih sustava (Danska, Francuska, Njemačka, EU prosjek, Hrvatska, Mađarska, Irska), razložen na neizravne poreze, izravne poreze te socijalne doprinose u postotku BDP-a."
#| fig-width: 7.8
#| fig-height: 4.0
source("R/setup.R")
...
//| fig-cap: "Porezni klin na rad za samca s prosječnom plaćom bez djece (porez na dohodak te doprinosi zaposlenika i poslodavca, kao udio u ukupnom trošku rada). Zlatno je Hrvatska, zeleno prosjek OECD-a. Izvor: OECD, Taxing Wages 2025; Hrvatska prema nacionalnoj procjeni po OECD-ovoj metodologiji (Blažić i Šeparović, 2019), uz oba obvezna mirovinska stupa."
//| fig-alt: "Vodoravni stupčasti graf poreznog klina na rad za jedanaest jedinica. Belgija je na vrhu s 52,5 %, Irska na dnu s 32,6 %. Hrvatska je istaknuta zlatno s oko 36 %, tik iznad prosjeka OECD-a od 35,1 %."
{
  const data = [
...
#| echo: false
#| fig-cap: "Porezni klin na rad za samca s prosječnom plaćom bez djece (porez na dohodak te doprinosi, kao udio u ukupnom trošku rada). Zlatno je Hrvatska, zeleno prosjek OECD-a. Izvor: OECD, Taxing Wages 2025; Hrvatska prema nacionalnoj procjeni po OECD-ovoj metodologiji (Blažić i Šeparović, 2019)."
#| fig-alt: "Vodoravni stupčasti graf poreznog klina na rad; Belgija 52,5 %, Irska 32,6 %, Hrvatska istaknuta zlatno s oko 36 %, blizu prosjeka OECD-a."
#| fig-width: 7.8
#| fig-height: 4.4
source("R/setup.R")
theme_set(theme_pubfin() + theme(
